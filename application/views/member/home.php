...
<head>
	...
	<!-- Custom-Files -->
	<link href="<?= base_url(); ?>assets/bower_components/bootstrap/dist/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap css -->
	<link href="<?= base_url(); ?>assets/member/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Main css -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/member/css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="<?= base_url(); ?>assets/member/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="<?= base_url(); ?>assets/member/css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->
...
<body>
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="<?= base_url(); ?>assets/member/images/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				<!-- //logo -->
									...
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">All Mobile Phones</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">All Mobile Accessories</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Cases & Covers</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Screen Protectors</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Power Banks</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">All Certified Refurbished</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Tablets</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Wearable Devices</a>
												</li>
												<li>
													<a href="<?= base_url(); ?>assets/member/product.html">Smart Home</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-6 multi-gd-img">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m1.jpg" alt="">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m2.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m3.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m4.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m5.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m6.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="product-sec1 product-sec2 px-sm-5 px-3">
							<div class="row">
								...
								<div class="col-md-8 bg-right-nut">
									<img src="<?= base_url(); ?>assets/member/images/image1.png" alt="">
								</div>
							</div>
						</div>
						<!-- //third section -->
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m7.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m8.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="<?= base_url(); ?>assets/member/single.html">BPL Washing Machine</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?= base_url(); ?>assets/member/images/m9.jpg" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="scroll">
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="<?= base_url(); ?>assets/member/images/k1.jpg" alt="" class="img-fluid">
										</div>
									...
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="<?= base_url(); ?>assets/member/images/k2.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="<?= base_url(); ?>assets/member/images/k3.jpg" alt="" class="img-fluid">
										</div>
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
		...
		<div class="agile-sometext py-md-5 py-sm-4 py-3">
			<div class="container">
				...
				<div class="sub-some mt-4">
					...
					<ul>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product.html" class="border-right pr-2">Offers & Coupons</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Couple Watches</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Gas Stoves</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2"> Air Coolers</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Air Purifiers</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Headphones</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2"> Headsets</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Pressure Cookers</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Sandwich Makers</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Air Friers</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Irons</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">LED TV</a>
						</li>
						<li class="m-sm-1">
							<a href="<?= base_url(); ?>assets/member/product2.html" class="border-right pr-2">Sandwich Makers</a>
						</li>
				...
				<div class="sub-some child-momu mt-4">
					...
					<ul>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay2.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay5.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay1.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay4.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay6.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay3.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay7.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay8.png" alt="">
						</li>
						<li>
							<img src="<?= base_url(); ?>assets/member/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="<?= base_url(); ?>assets/member/js/jquery-2.2.3.min.js"></script>
	<!-- //jquery -->
	...
	<script src="<?= base_url(); ?>assets/member/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- cart-js -->
	<script src="<?= base_url(); ?>assets/member/js/minicart.js"></script>
	<script>
	...
	<!-- scroll seller -->
	<script src="<?= base_url(); ?>assets/member/js/scroll.js"></script>
	<!-- //scroll seller -->

	<!-- smoothscroll -->
	<script src="<?= base_url(); ?>assets/member/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?= base_url(); ?>assets/member/js/move-top.js"></script>
	<script src="<?= base_url(); ?>assets/member/js/easing.js"></script>
	<script>
	...
	<script src="<?= base_url(); ?>assets/member/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
</body>
